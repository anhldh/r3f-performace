...
//       if (TexCount > 0) setTexNumber(TexCount);
//       set(format);
//     }
...
//         <div
//           className={s.perfI}
//           style={{ height: "auto", width: "auto", margin: "0 4px" }}
//         >
...
//         }}
//       >
//         <div className={s.toggle} style={{ marginRight: "6px" }}>
//           {/* Toggle Icon placeholder: {toggleProgram ? '▼' : '▲'} */}
//           <span>{toggleProgram ? "▼" : "▶"}</span>
//         </div>

//         {program && (
//           <span>
//             <span className={s.programTitle}>{program.name}</span>
...
//       >
//         <div className={s.programsULHeader}>Uniforms:</div>
//         <UniformsGL
//           program={program}
//           material={material}
